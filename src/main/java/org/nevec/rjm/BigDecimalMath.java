        ...
        static public BigDecimal sin(final BigDecimal x)
        {
                ...
                else
                {
                        ...
                        */
                        ...
                        MathContext mc = new MathContext( Math.max(1, 2+err2prec(3.14159,errpi)) ) ;
                        BigDecimal p= pi(mc) ;
                                ...
                                */
                                ...
                                else
                                {
                                        ...
                                        */
                                        ...
                                        MathContext mcTay = new MathContext( Math.max(1, err2prec(res.doubleValue(),xUlpDbl/k)) ) ;
                                        for(int i=1 ; ; i++)
                                        {
        ...
        */
        static public BigDecimal mod2pi(BigDecimal x)
        {
                ...
                */
                ...
                MathContext mc = new MathContext( Math.max(0, 2+err2prec(6.283,err2pi)) ) ;
                ...
                */
                mc = new MathContext( Math.max(1, err2prec(res.doubleValue(),x.ulp().doubleValue()/2.)) ) ;
                return res.round(mc) ;
        } /* mod2pi */
...
1.577721810442023616644432780e-30,7.888609052210118073520537800e-31
        ...
        */
        static public BigDecimal subtractRound(final BigDecimal x, final BigDecimal y)
        {
                ...
                */
                double errR = Math.abs( y.ulp().doubleValue()/2. ) + Math.abs( x.ulp().doubleValue()/2. ) ;
                MathContext mc = new MathContext( Math.max(1, err2prec(resul.doubleValue(),errR)) ) ;
                return resul.round(mc) ;
        } /* subtractRound */
